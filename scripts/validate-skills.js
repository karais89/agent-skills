...
const SECTION_EXEMPT_SKILLS = {
  ...
  'idea-refine':        'Legacy structure predating skill-anatomy.md — uses How-It-Works/Usage/Anti-patterns instead of standard headings. Tracked for future conformance.',
};
